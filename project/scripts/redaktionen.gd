...
var bubble_news: Array[News] = [
	...
	func(): Market.manipulate_stock(5, 40, false, false, 6)),
	...
	func(): Market.manipulate_stock(2, 60, false, false, 8)),
	News.new(9, "Electric records", "Energy sector is recording record profits!",
	func(): Market.manipulate_industry(3, 30, false, 8)),
	...
	func(): Market.manipulate_industry(1, 30, true, 12)),
	...
	func(): Market.manipulate_industry(3, 30, true, 18)),
