...
var burst_news: Array[News] = [
	News.new(1, "Tentron plans anger", "Tentron accused of shutting down facilitys in order to inflate energy price",
	func(): pass, 
	...
	News.new(1, "Vattenmakt losing power", "Neglected upkeep keeps dams from running on full effect. Jount energy venture scrambling to find alternate sources",
